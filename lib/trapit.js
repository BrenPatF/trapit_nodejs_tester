...
const self = module.exports = {
  ...
  *************************************************************************************************/
  prUTResultsText: (meta, scenarios) => {
    const results = self.getUTResults(meta, scenarios);
    prUTResults(results, '.txt', Text);
  },
  prUTResultsHTML: (meta, scenarios) => {
    const results = self.getUTResults(meta, scenarios);
    prUTResults(results, '.html', Html);
  },
  prUTResultsTextAndHTML: (meta, scenarios) => {
    const results = self.getUTResults(meta, scenarios);
    prUTResults(results, '.txt', Text);
    prUTResults(results, '.html', Html);
  }
